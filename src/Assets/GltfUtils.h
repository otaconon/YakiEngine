...
namespace GltfUtils
{
    ...
    [[nodiscard]] std::optional<std::shared_ptr<GltfObject>> load_gltf_object(VulkanContext* ctx, const std::filesystem::path& filePath, Material& material, DefaultData& defaultData);
