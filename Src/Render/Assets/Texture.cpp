...
Texture::Texture(fastgltf::Asset &gltfAsset, fastgltf::Image &gltfImage) {
      ...
      fastgltf::visitor{
          ...
          [&](fastgltf::sources::URI &filePath) {
            ...
            if (data) {
              ...
              *this = Texture(m_ctx, m_ctx->GetAllocator(), data, imagesize, VK_FORMAT_R8G8B8A8_UNORM,
                ...
                fastgltf::visitor{
                    ...
                    [&](fastgltf::sources::Array &vector) {
                      ...
                      if (data) {
                        ...
                        *this = Texture(m_ctx, m_ctx->GetAllocator(), data, imagesize, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_USAGE_SAMPLED_BIT, true);
