...
public:
  ...
  [[nodiscard]] std::shared_ptr<Texture> GetDrawTexture();
  [[nodiscard]] std::shared_ptr<Texture> GetDepthTexture();
...
private:
  ...
  std::shared_ptr<Texture> m_drawImage{};
  std::shared_ptr<Texture> m_depthImage{};
